...
left join departamentos d on m.depto_cod_espec = d.cod_especialidade*/
...
/*select distinct d.nome_especialidade from departamentos d
...
/*select nome, email from medicos where telefone = '' or telefone is null*/
